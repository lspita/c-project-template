...
- EXEC_PATTERNS (list, default=main *.main) list of patterns matching sources
  that are executables (without last file extension)
- TEST_PATTERNS (list, default=*.test) list of patterns matching sources
  that are tests (without last file extension)
...
- CMAKE_TEMPLATES_DIR (string, default=cmake) CMAKE_DIR subdirectory containing
  template files
- CLANG_TIDY (string, default=clang-tidy) clang tidy executable, unset to stop using
  clang tidy
]]#
